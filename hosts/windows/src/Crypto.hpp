#pragma once
// The cryptography the update trust root needs (contract §7.1): SHA-256 over the payload (Windows
// CNG) and ed25519 signature verification (tweetnacl). Node signs the sha256 digest directly
