#pragma once
// The stdio control channel the conformance runner drives (conformance/hosts/linux/driver.js).
...
// results back over the webkit script-message channel, and Bridge's onConf* callbacks land here.
#include <mutex>
#include <string>
